...
public class TaskList extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Course Completion:");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            stm.executeQuery(sqlQuery);

            //input to table
            String sqlDetails = "INSERT into TaskDetails VALUES('" + taskName + "', '" + description + "', '" + status + "', '" + cat + "')";

            //execute statment
            stm.executeUpdate(sqlDetails);
            ...
            JFrame popUp;
            popUp = new JFrame();
            JOptionPane.showMessageDialog(popUp, "Task successfully added");
            ...
            JFrame popUp;
            popUp = new JFrame();
            JOptionPane.showMessageDialog(popUp, "Connection Error: " + ex.getMessage());
